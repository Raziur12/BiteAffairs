...
class OrderService {
  ...
  async submitOrder(orderData) {
    try {
      console.log('Submitting order for admin approval:', orderData);
      ...
      console.log('Order submitted successfully:', savedOrder.orderId);
  ...
  async notifyCustomerOrderApproved(orderData) {
    ...
    console.log('Notifying customer of order approval:', orderData.orderId);
  ...
  async notifyCustomerOrderRejected(orderData) {
    ...
    console.log('Notifying customer of order rejection:', orderData.orderId);
